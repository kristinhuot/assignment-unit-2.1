...
let food = 'Vietnamese, Greek, or GF goat cheese pizza!';
console.log( 'My favorite foods are ' + food );
// 8 - Create a variable called `pets` and set it to the value of the number of pets you have
//     Console log the value of `pets`
let pets = 0;
console.log( 'This is how many pets I currently have', + pets );
// 9 - Create a variable called `friendsPets` and assign it the value of the number of pets your friend has
let friendsPets = 1;
console.log( 'This is how many pets my friend has', friendsPets );
// 10 - Add two pets to your `pets` variable
friendsPets = friendsPets += 2; 
console.log( 'This is how many pets my friend has plus two', friendsPets );
// 11 - Create a constant variable called `allowedPets` and set it to a number value of your choice
const allowedPets = 4;  
console.log( 'This is how many pets are allowed', allowedPets );
...
console.log( 'Go on adventures or stay at home?', result );
...
console.log( 'Lets roll the dice!', diceRoll );
...
console.log( 'To have more pets or not to have more pets, that is the question...', petStatus );
// STRETCH GOALS:
